...
import { Dumbbell, ShieldAlert, CheckCircle, Activity, Award, Flame } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex text-white relative overflow-hidden font-sans">
        ...
        <div className="max-w-xl my-auto space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-6 border-t border-slate-900">
            <div className="space-y-1">
              ...
              <p className="text-slate-450 text-xxs">Record reps, sets, and weights inside a single transaction flow.</p>
            </div>
            <div className="space-y-1">
              <div className="flex items-center gap-1.5 text-lime-400">
              ...
              <p className="text-slate-450 text-xxs">Tracks heaviest weight per exercise and updates your peaks on-the-fly.</p>
            </div>
            <div className="space-y-1">
              <div className="flex items-center gap-1.5 text-lime-400">
              ...
              <p className="text-slate-450 text-xxs">Analyzes logs consecutively to calculate training streaks.</p>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-2/5 flex items-center justify-center p-8 relative z-10">
        <div className="w-full max-w-md bg-slate-900/40 backdrop-blur-xl border border-slate-900 rounded-3xl p-8 shadow-2xl flex flex-col space-y-6">
          {/* Logo displays on mobile header */}
          <div className="flex lg:hidden flex-col items-center mb-2">
            <div className="flex items-center justify-center h-11 w-11 rounded-xl bg-lime-400 text-slate-950 font-black mb-3">
          ...
          <div className="space-y-2 text-center lg:text-left">
            <h2 className="text-2xl font-black uppercase tracking-wide">Welcome Back</h2>
            <p className="text-slate-400 text-xs font-semibold">Enter your credentials to enter your athlete dashboard</p>
          </div>
            ...
            <div className="space-y-4">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  type="text"
                  required
                  className="w-full px-4 py-2.5 bg-slate-950 border border-slate-850 rounded-xl text-white placeholder-slate-650 focus:outline-none focus:ring-2 focus:ring-lime-400/30 focus:border-lime-400 text-sm transition-all"
          ...
          <div className="text-center border-t border-slate-850 pt-4">
            <p className="text-xs text-slate-450 font-medium">
              ...
              <Link to="/register" className="font-bold text-lime-450 hover:text-lime-300 transition-colors uppercase tracking-wider">
                Register here
              </Link>
            </p>
          </div>
